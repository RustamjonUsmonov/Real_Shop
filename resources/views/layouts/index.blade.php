...
<!-- AdminLTE App -->
<!--
<link rel="script" href="{{asset('js/adminlte.js')}}">
-->
...
<script type='text/javascript' src='{{asset('js/admin-lte.js')}}'></script>
<!-- AdminLTE for demo purposes -->
<link rel="script" href="{{asset('js/demo.js')}}">
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<link rel="script" href="{{asset('js/pages/dashboard.js')}}">
